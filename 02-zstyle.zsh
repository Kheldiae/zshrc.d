...
zstyle ':completion:*' list-prompt      $'%{\e[38;2;230;219;116m\e[38;5;232;48;2;230;219;116m%} SCROLL %{\e[38;2;198;198;198;48;2;48;48;48m%} At %p %{\e[0;38;2;48;48;48m%} %{\e[0m%}'
zstyle ':completion:*' matcher-list     '' \
                                        'm:{[:lower:]}={[:upper:]} l:|=* r:|=*' \
                                        'm:{[:lower:][:upper:]}={[:upper:][:lower:]} l:|=* r:|=*'
zstyle ':completion:*' menu             select=long-list select=0 select=0
zstyle ':completion:*' original         true
zstyle ':completion:*' select-prompt   $'%{\e[38;2;128;160;255m\e[38;5;232;48;2;128;160;255m%} SELECT %{\e[38;2;198;198;198;48;2;48;48;48m%} At %p %{\e[0;38;2;48;48;48m%}%{\e[0m%}'
